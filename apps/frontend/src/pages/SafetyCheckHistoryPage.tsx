                  ...
                  <div key={inspection.id} className="group relative">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="mt-2 flex items-center gap-3">
                          <div className="h-1.5 w-24 overflow-hidden rounded-full bg-surface-sunken shadow-neu-pressed">
                            <div
                    ...
                    {canDelete && (
                      <button
                        ...
                        title="작성 중 점검 삭제"
                        className="absolute right-4 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-lg bg-surface-raised text-text-muted shadow-neu-raised transition-[background-color,color,box-shadow] hover:bg-danger-soft hover:text-danger active:shadow-neu-pressed disabled:opacity-40"
                      >
